...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Mensaje de prueba!!");
        description.setForeground(new Color(245, 245, 245));
        add(description);
        description1 = new JLabel("Entrar con info personal");
    ...
    private void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("Detalles personales:");
                description1.setText("Mensaje de prueba2");
                button.setText("REGISTRATE!!");
            } else {
                title.setText("Bienvenido de Nuevo!");
                description.setText("mensaje de prueba 3");
                description1.setText("entra con tu info personal");
